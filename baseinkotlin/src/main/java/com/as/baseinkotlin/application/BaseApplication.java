package com.as.baseinkotlin.application;

import android.app.Application;
import com.as.baseinkotlin.greendao.MySQLiteOpenHelper;
...
//        daoSession = daoMaster.newSession();
        MySQLiteOpenHelper helper = new MySQLiteOpenHelper(this, "user.db",
                null);
        daoSession = new DaoMaster(helper.getEncryptedWritableDb("asdf1234")).newSession();
    }
